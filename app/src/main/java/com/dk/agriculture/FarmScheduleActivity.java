...
public class FarmScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("farmer").child("9769084086").child("myBatches").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            ((ViewHolder)holder).harvest.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    FirebaseDatabase.getInstance().getReference("farmer").child("9769084086").child("myBatches").child(batchModels.get(position).getId()).removeValue();
                    FirebaseDatabase.getInstance().getReference("farmer").child("9769084086").child("myBatches").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(!dataSnapshot.exists()){
